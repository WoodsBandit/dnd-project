...
# Create cone: hat_cone
bpy.ops.mesh.primitive_cone_add(radius1=0.0030800000000000007, radius2=0,
    depth=0.005040000000000001, vertices=24, location=(0, 0, 0.02834))
obj = bpy.context.active_object
obj.name = "hat_cone"


# Create torus: hat_brim
bpy.ops.mesh.primitive_torus_add(major_radius=0.0028000000000000004, minor_radius=0.00044800000000000005,
    major_segments=24, minor_segments=8, location=(0, 0, 0.0261))
obj = bpy.context.active_object
obj.name = "hat_brim"
...
bpy.ops.mesh.primitive_cone_add(radius1=0.00039200000000000004, radius2=0.0005040000000000001,
    depth=0.0051072, vertices=24, location=(-0.0033152000000000004, 0.00076608, 0.018761760000000002))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_uv_sphere_add(radius=0.00044800000000000005, segments=16,
    ring_count=8, location=(-0.0035392000000000006, 0.00114912, 0.016463520000000002))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cone_add(radius1=0.0003136000000000001, radius2=0.00039200000000000004,
    depth=0.004788000000000001, vertices=24, location=(-0.0037632000000000004, 0.00234612, 0.014069520000000002))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cube_add(size=0.0019600000000000004, location=(-0.0038752000000000005, 0.0033037200000000004, 0.011914920000000002))
obj = bpy.context.active_object
obj.name = "arm_L_hand"
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.00015680000000000004, depth=0.0007840000000000002,
    vertices=6, location=(-0.0034342000000000005, 0.0037937200000000004, 0.011228920000000002))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.00015680000000000004, depth=0.0007840000000000002,
    vertices=6, location=(-0.0037282000000000005, 0.0037937200000000004, 0.011228920000000002))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.00015680000000000004, depth=0.0007840000000000002,
    vertices=6, location=(-0.004022200000000001, 0.0037937200000000004, 0.011228920000000002))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.00015680000000000004, depth=0.0007840000000000002,
    vertices=6, location=(-0.004316200000000001, 0.0037937200000000004, 0.011228920000000002))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.00017640000000000003, depth=0.0005880000000000001,
    vertices=6, location=(-0.0044632000000000005, 0.0034997200000000004, 0.011718920000000002))
obj = bpy.context.active_object
...
# Create cylinder: staff_shaft
bpy.ops.mesh.primitive_cylinder_add(radius=0.00063, depth=0.0252,
    vertices=24, location=(0.0035280000000000008, 0.01, 0.013360000000000004))
obj = bpy.context.active_object
obj.name = "staff_shaft"


# Create sphere: staff_orb
bpy.ops.mesh.primitive_uv_sphere_add(radius=0.002205, segments=24,
    ring_count=12, location=(0.0035280000000000008, 0.01, 0.026464000000000005))
obj = bpy.context.active_object
obj.name = "staff_orb"


# Create torus: staff_cradle
bpy.ops.mesh.primitive_torus_add(major_radius=0.001764, minor_radius=0.000504,
    major_segments=24, minor_segments=8, location=(0.0035280000000000008, 0.01, 0.024700000000000007))
obj = bpy.context.active_object
obj.name = "staff_cradle"


# Create sphere: staff_cap
bpy.ops.mesh.primitive_uv_sphere_add(radius=0.0009450000000000001, segments=16,
    ring_count=8, location=(0.0035280000000000008, 0.01, 0.0007600000000000037))
obj = bpy.context.active_object
obj.name = "staff_cap"


# Scale: staff_cap
bpy.data.objects["staff_cap"].scale = (1.0, 1.0, 0.6)


# Create cone: robe_skirt
bpy.ops.mesh.primitive_cone_add(radius1=0.00378, radius2=0.00168,
    depth=0.0042, vertices=32, location=(0, 0, 0.012240000000000003))
obj = bpy.context.active_object
obj.name = "robe_skirt"


# Union objects into: wizard
# Using boolean EXACT solver for watertight results
base_obj = bpy.data.objects["base"]
bpy.context.view_layer.objects.active = base_obj


# Boolean union: adding hat_cone
tool_obj = bpy.data.objects["hat_cone"]
...
# Boolean union: adding hat_brim
tool_obj = bpy.data.objects["hat_brim"]
...
# Boolean union: adding staff_shaft
tool_obj = bpy.data.objects["staff_shaft"]
...
# Boolean union: adding staff_orb
tool_obj = bpy.data.objects["staff_orb"]
...
# Boolean union: adding staff_cradle
tool_obj = bpy.data.objects["staff_cradle"]
...
# Boolean union: adding staff_cap
tool_obj = bpy.data.objects["staff_cap"]
...
base_obj.name = "wizard"


# Clean mesh for printing: wizard
obj = bpy.data.objects["wizard"]
...
print(f"Mesh cleaned: wizard")


# Add subdivision surface: wizard
obj = bpy.data.objects["wizard"]
...
bpy.ops.wm.stl_export(
    filepath="C:/Users/Xx LilMan xX/Documents/Claude Docs/dnd/3d-prints/miniatures/characters/wizard-quality.stl",
    export_selected_objects=True,
    global_scale=1.0,
    ascii_format=False  # Binary STL is smaller and faster
)
print("Exported: C:/Users/Xx LilMan xX/Documents/Claude Docs/dnd/3d-prints/miniatures/characters/wizard-quality.stl")
