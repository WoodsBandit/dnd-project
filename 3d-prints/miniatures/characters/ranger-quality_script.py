...
bpy.ops.mesh.primitive_cube_add(size=0.0022400000000000002, location=(0.0018164999999999998, 0.0016116800000000003, 0.0028387200000000025))
obj = bpy.context.active_object
obj.name = "leg_R_foot"
...
# Create cone: tusk_L
bpy.ops.mesh.primitive_cone_add(radius1=0.000224, radius2=0,
    depth=0.0005600000000000001, vertices=6, location=(-0.0008400000000000001, 0.0014000000000000002, 0.023020000000000002))
obj = bpy.context.active_object
obj.name = "tusk_L"


# Rotate: tusk_L (degrees)
import math
bpy.data.objects["tusk_L"].rotation_euler = (
    math.radians(-60),
    math.radians(0),
    math.radians(0)
)
...
# Rotate: tusk_R (degrees)
import math
bpy.data.objects["tusk_R"].rotation_euler = (
    math.radians(-60),
    math.radians(0),
    math.radians(0)
)
...
# Create sphere: hood
bpy.ops.mesh.primitive_uv_sphere_add(radius=0.0033600000000000006, segments=24,
    ring_count=10, location=(0, -0.0005600000000000001, 0.024980000000000002))
obj = bpy.context.active_object
obj.name = "hood"


# Scale: hood
bpy.data.objects["hood"].scale = (0.95, 0.8, 1.0)


# Create sphere: arm_R_shoulder
bpy.ops.mesh.primitive_uv_sphere_add(radius=0.0006720000000000001, segments=16,
    ring_count=8, location=(0.0031360000000000008, 0, 0.021060000000000002))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cone_add(radius1=0.00039200000000000004, radius2=0.0005040000000000001,
    depth=0.0051072, vertices=24, location=(0.0034720000000000007, 0.00051072, 0.01927248))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_uv_sphere_add(radius=0.00044800000000000005, segments=16,
    ring_count=8, location=(0.003696000000000001, 0.0007660799999999999, 0.01748496))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cone_add(radius1=0.0003136000000000001, radius2=0.00039200000000000004,
    depth=0.004788000000000001, vertices=24, location=(0.003920000000000001, 0.0014842800000000001, 0.01509096))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cube_add(size=0.0019600000000000004, location=(0.004032000000000001, 0.00205884, 0.012936360000000001))
obj = bpy.context.active_object
obj.name = "arm_R_hand"
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.00015680000000000004, depth=0.0007840000000000002,
    vertices=6, location=(0.003591000000000001, 0.00254884, 0.01225036))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.00015680000000000004, depth=0.0007840000000000002,
    vertices=6, location=(0.003885000000000001, 0.00254884, 0.01225036))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.00015680000000000004, depth=0.0007840000000000002,
    vertices=6, location=(0.004179000000000001, 0.00254884, 0.01225036))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.00015680000000000004, depth=0.0007840000000000002,
    vertices=6, location=(0.004473000000000001, 0.00254884, 0.01225036))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.00017640000000000003, depth=0.0005880000000000001,
    vertices=6, location=(0.004620000000000001, 0.00225484, 0.012740360000000001))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cone_add(radius1=0.00039200000000000004, radius2=0.0005040000000000001,
    depth=0.0051072, vertices=24, location=(-0.0034720000000000007, 0.0012768, 0.01888944))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_uv_sphere_add(radius=0.00044800000000000005, segments=16,
    ring_count=8, location=(-0.003696000000000001, 0.0019152000000000001, 0.016718880000000002))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cone_add(radius1=0.0003136000000000001, radius2=0.00039200000000000004,
    depth=0.004788000000000001, vertices=24, location=(-0.003920000000000001, 0.0033516000000000006, 0.014324880000000002))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cube_add(size=0.0019600000000000004, location=(-0.004032000000000001, 0.004500720000000001, 0.012170280000000002))
obj = bpy.context.active_object
obj.name = "arm_L_hand"
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.00015680000000000004, depth=0.0007840000000000002,
    vertices=6, location=(-0.003591000000000001, 0.004990720000000001, 0.011484280000000001))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.00015680000000000004, depth=0.0007840000000000002,
    vertices=6, location=(-0.003885000000000001, 0.004990720000000001, 0.011484280000000001))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.00015680000000000004, depth=0.0007840000000000002,
    vertices=6, location=(-0.004179000000000001, 0.004990720000000001, 0.011484280000000001))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.00015680000000000004, depth=0.0007840000000000002,
    vertices=6, location=(-0.004473000000000001, 0.004990720000000001, 0.011484280000000001))
obj = bpy.context.active_object
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.00017640000000000003, depth=0.0005880000000000001,
    vertices=6, location=(-0.004620000000000001, 0.004696720000000001, 0.011974280000000002))
obj = bpy.context.active_object
...
# Create cylinder: bow_limb_0
bpy.ops.mesh.primitive_cylinder_add(radius=0.0005040000000000001, depth=0.007560000000000002,
    vertices=16, location=(-0.0035280000000000008, 0.016344, 0.024196000000000002))
obj = bpy.context.active_object
obj.name = "bow_limb_0"


# Rotate: bow_limb_0 (degrees)
import math
bpy.data.objects["bow_limb_0"].rotation_euler = (
    math.radians(15),
    math.radians(0),
    math.radians(0)
)
...
# Create cylinder: bow_limb_1
bpy.ops.mesh.primitive_cylinder_add(radius=0.0005040000000000001, depth=0.007560000000000002,
    vertices=16, location=(-0.0035280000000000008, 0.016344, 0.016804))
obj = bpy.context.active_object
obj.name = "bow_limb_1"


# Rotate: bow_limb_1 (degrees)
import math
bpy.data.objects["bow_limb_1"].rotation_euler = (
    math.radians(-15),
    math.radians(0),
    math.radians(0)
)
...
# Create cylinder: bow_grip
bpy.ops.mesh.primitive_cylinder_add(radius=0.0007560000000000002, depth=0.00252,
    vertices=16, location=(-0.0035280000000000008, 0.015, 0.0205))
obj = bpy.context.active_object
obj.name = "bow_grip"


# Create cylinder: bow_string
bpy.ops.mesh.primitive_cylinder_add(radius=0.00015120000000000002, depth=0.014280000000000001,
    vertices=8, location=(-0.0035280000000000008, 0.014664, 0.0205))
obj = bpy.context.active_object
obj.name = "bow_string"


# Create cylinder: quiver
bpy.ops.mesh.primitive_cylinder_add(radius=0.00042, depth=0.0028000000000000004,
    vertices=16, location=(0.0027440000000000003, -0.0005600000000000001, 0.018820000000000003))
obj = bpy.context.active_object
obj.name = "quiver"


# Rotate: quiver (degrees)
import math
bpy.data.objects["quiver"].rotation_euler = (
    math.radians(15),
    math.radians(0),
    math.radians(0)
)
...
# Create cylinder: arrow_0
bpy.ops.mesh.primitive_cylinder_add(radius=8.400000000000001e-05, depth=0.00336,
    vertices=6, location=(0.0025200000000000005, -0.0005600000000000001, 0.019380000000000005))
obj = bpy.context.active_object
obj.name = "arrow_0"


# Rotate: arrow_0 (degrees)
import math
bpy.data.objects["arrow_0"].rotation_euler = (
    math.radians(10),
    math.radians(0),
    math.radians(0)
)
...
# Create cylinder: arrow_1
bpy.ops.mesh.primitive_cylinder_add(radius=8.400000000000001e-05, depth=0.00336,
    vertices=6, location=(0.0027440000000000003, -0.0005600000000000001, 0.019380000000000005))
obj = bpy.context.active_object
obj.name = "arrow_1"


# Rotate: arrow_1 (degrees)
import math
bpy.data.objects["arrow_1"].rotation_euler = (
    math.radians(10),
    math.radians(0),
    math.radians(0)
)
...
# Create cylinder: arrow_2
bpy.ops.mesh.primitive_cylinder_add(radius=8.400000000000001e-05, depth=0.00336,
    vertices=6, location=(0.002968, -0.0005600000000000001, 0.019380000000000005))
obj = bpy.context.active_object
obj.name = "arrow_2"


# Rotate: arrow_2 (degrees)
import math
bpy.data.objects["arrow_2"].rotation_euler = (
    math.radians(10),
    math.radians(0),
    math.radians(0)
)
...
# Create cone: cloak
bpy.ops.mesh.primitive_cone_add(radius1=0.0042, radius2=0.003920000000000001,
    depth=0.005600000000000001, vertices=32, location=(0, -0.00028000000000000003, 0.015040000000000003))
obj = bpy.context.active_object
obj.name = "cloak"


# Union objects into: ranger
# Using boolean EXACT solver for watertight results
base_obj = bpy.data.objects["base"]
bpy.context.view_layer.objects.active = base_obj


# Boolean union: adding tusk_L
tool_obj = bpy.data.objects["tusk_L"]
...
# Boolean union: adding tusk_R
tool_obj = bpy.data.objects["tusk_R"]
...
# Boolean union: adding hood
tool_obj = bpy.data.objects["hood"]
...
# Boolean union: adding quiver
tool_obj = bpy.data.objects["quiver"]
...
# Boolean union: adding cloak
tool_obj = bpy.data.objects["cloak"]
...
# Boolean union: adding arrow_0
tool_obj = bpy.data.objects["arrow_0"]
...
# Boolean union: adding arrow_1
tool_obj = bpy.data.objects["arrow_1"]
...
# Boolean union: adding arrow_2
tool_obj = bpy.data.objects["arrow_2"]
...
# Boolean union: adding bow_limb_0
tool_obj = bpy.data.objects["bow_limb_0"]
...
# Boolean union: adding bow_limb_1
tool_obj = bpy.data.objects["bow_limb_1"]
...
# Boolean union: adding bow_grip
tool_obj = bpy.data.objects["bow_grip"]
...
# Boolean union: adding bow_string
tool_obj = bpy.data.objects["bow_string"]
...
base_obj.name = "ranger"


# Clean mesh for printing: ranger
obj = bpy.data.objects["ranger"]
...
print(f"Mesh cleaned: ranger")


# Add subdivision surface: ranger
obj = bpy.data.objects["ranger"]
...
bpy.ops.wm.stl_export(
    filepath="C:/Users/Xx LilMan xX/Documents/Claude Docs/dnd/3d-prints/miniatures/characters/ranger-quality.stl",
    export_selected_objects=True,
    global_scale=1.0,
    ascii_format=False  # Binary STL is smaller and faster
)
print("Exported: C:/Users/Xx LilMan xX/Documents/Claude Docs/dnd/3d-prints/miniatures/characters/ranger-quality.stl")
